...
export function SignupForm({ className, onClickSignIn, onCreateSuccess }: SignUpFormProps) {
	...
	const handleSubmitForm: SubmitEventHandler<HTMLFormElement> = (evt) => {
		evt.preventDefault();
		handleSubmit((data) =>
			onSignup(
				{
				...
				<form ref={formRef} onSubmit={handleSubmitForm}>
					<FieldGroup>
						...
						<Controller
							control={control}
							name="name"
							render={({ fieldState: { error, invalid }, field }) => (
								<Field aria-invalid={invalid}>
									<FieldLabel htmlFor="name">Name</FieldLabel>
									<Input {...field} id="name" placeholder="Name" required />
